...
(() => {
  ...
  // ---- Config ----
  const API_BASE = "https://piece-by-piece-api.sbrooks-572.workers.dev"; // same-origin; override for local dev
  ...
  function renderProducts(products) {
    ...
    if (!products.length) {
      grid.innerHTML =
        '<p class="loading">All pieces have found homes. Check back soon.</p>';
      return;
    }
    ...
    grid.querySelectorAll("[data-inquire]").forEach((btn) => {
      btn.addEventListener("click", () => {
        ...
        if (msg)
          msg.value = `Hi, I\u2019m interested in the "${name}". Is it still available?`;
        document
  ...
  const fallbackProducts = [
    {
      name: "Restored Oak Dresser",
      slug: "restored-oak-dresser",
      description: "Six drawers. Dovetail joints. Sanded to satin.",
      price_cents: 89500,
      category: "Bedroom",
      sold: 0,
    },
    {
      ...
      description: "Tapered legs. Brass pulls. One careful owner before us.",
      price_cents: 34500,
      category: "Bedroom",
      sold: 0,
    },
    {
      ...
      description: "Seats eight. Pine top, chalk-white trestle base.",
      price_cents: 120000,
      category: "Dining",
      sold: 0,
    },
    {
      ...
      slug: "art-deco-vanity",
      description: "Beveled glass. Gilded frame brought back to life.",
      price_cents: 24500,
      category: "Accent",
      sold: 0,
    },
    {
      ...
      description:
        "Reclaimed lumber. Iron pipe frame. Five shelves of character.",
      price_cents: 67500,
    ...
    },
    {
      ...
      slug: "victorian-writing-desk",
      description: "Roll-top. Hidden compartments. Mahogany, refinished twice.",
      price_cents: 95000,
      category: "Office",
      sold: 0,
    },
  ...
  const fallbackTestimonials = [
    {
      customer: "Margaret & Paul",
      location: "Asheville, NC",
      quote:
        "The dresser arrived and we just stood there. It looked like it had always been ours.",
      piece_name: "Restored Oak Dresser",
      rating: 5,
    },
    {
      customer: "James T.",
      location: "Savannah, GA",
      quote: "Built solid. Finished beautiful. No notes.",
      piece_name: "Farmhouse Dining Table",
      rating: 5,
    },
    {
      customer: "Diane Kowalski",
      location: "Portland, ME",
      quote:
        "I called about one piece and left with three. Everything they touch turns to gold.",
      piece_name: null,
      rating: 5,
    },
    {
      customer: "The Reeves Family",
      location: "Charleston, SC",
      quote:
        "Our daughter spilled grape juice on it the first week. Wiped right off. That finish is no joke.",
      piece_name: "Mid-Century Walnut Nightstand",
      rating: 4,
    },
  ];
